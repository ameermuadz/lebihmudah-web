...
export default function PropertyCard({ property }: PropertyCardProps) {
  return (
    ...
    >
      <article className="overflow-hidden rounded-xl border border-zinc-300 bg-white/90 text-zinc-900 shadow-lg transition hover:border-zinc-400 dark:border-zinc-700 dark:bg-zinc-900/80 dark:text-white dark:hover:border-zinc-500">
        <Image
        ...
        <div className="space-y-2 p-4">
          ...
          <div className="flex flex-wrap gap-2 text-xs">
            ...
            <span className="rounded-full bg-zinc-200 px-2 py-1 text-zinc-700 dark:bg-zinc-700 dark:text-zinc-200">
